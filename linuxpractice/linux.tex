...
\begin{figure}
\centering
\includegraphics[height=2.1in, width=3.5in]{avgchgerfileonmod(b).eps}
...
\begin{figure}
\centering
\includegraphics[height=2.1in, width=3.5in]{chgerfkernel.eps} %10*6
...
\begin{figure}
\centering
\includegraphics[height=2.1in, width=3.5in]{chgerfdrivers.eps} %10*6
...
\begin{figure}
\centering
\includegraphics[height=2.1in, width=3.5in]{fdvprkernel.eps} %10*6
...
\begin{figure}
\centering
\includegraphics[height=2.1in, width=3.5in]{fdvprdrivers.eps} %10*6
